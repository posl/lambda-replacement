...
public class TreeSitterLambda {
    ...
    private static final Set<String> STATEMENTS = Set.of(
            ...
            "try_statement", "declare_statement", "echo_statement", "exit_statement",
            "unset_statement", "const_declaration", "function_definition", "class_declaration",
    ...
    public static ArrayList<String[]> explore_lambda(String srcCode, String dstCode)
        ...
        PhpTreeSitterNgTreeGenerator treeGenerator = new PhpTreeSitterNgTreeGenerator();
